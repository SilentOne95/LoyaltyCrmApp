...
public class GridViewProductAdapter extends ArrayAdapter<Item> {
     ...
     */
    public GridViewProductAdapter(@NonNull Activity context, @NonNull ArrayList<Item> gridItem, boolean showDescription) {
