...
public class SwitchLayoutPresenter implements MainActivityContract.SwitchLayoutPresenter, BaseFragmentContract.Presenter {

    @Nullable
    private MainActivityContract.View view;

    SwitchLayoutPresenter(@Nullable MainActivityContract.View view) { this.view = view; }
